...
d3.path.icons = {
	...
	exclamation:function(size){
		return [
			{x:size/10,y:0},
			{x:0,y:size/10},
			{x:0,y:size*6/10},
			{x:size/10,y:size*7/10},
			{x:size/10,y:size*8/10},
			{x:0,y:size*9/10},
			{x:size/10,y:size},
			{x:size/5,y:size*9/10},
			{x:size/10,y:size*8/10},
			{x:size/10,y:size*7/10},
			{x:size/5,y:size*6/10},
			{x:size/5,y:size/10},
		];
	},
	tickOk:function(size){
		return [
			{x:0,y:size*2/5},
			{x:0,y:size*5/10},
			{x:size*2/5,y:size*4/5},
			{x:size*3/5,y:size*6/10},
			{x:size,y:0},
			{x:size*3/5,y:size*2/5},
			{x:size*2/5,y:size*5/10},
			{x:size*1/5,y:size*3/10},
		];
	},
